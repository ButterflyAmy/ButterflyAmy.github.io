export const characters = [
  {
    ...
    role: "Crown Prince of Xianle",
    vibe: "soft, celestial, gentle, resilient",
    quote: "Body in abyss, heart in paradise.",
    cover: "images/xl.png",
    gallery: [
      "images/xl2.png",
      "images/xl3.png",
    ...
    music: [
      ...
      { title: "Summertime Sadness", artist: "Lana Del Rey", url: "music/summertime sadness - lana del rey [edit audio].mp3" }
    ],
    defaultTrack: 0,
    tags: ["god", "gentle", "tragic", "devotion"]
  },
  {
    id: 2,
    slug: "hua-cheng",
    ...
    gallery: [
      ...
      "images/twi_ @rabbitamika.jpg",
      "images/Tgcf short movie ࣪˖ ִֶָ𐀔 ⊹.jpg"
    ],
    videos: [
      "videos/hua-cheng-edit.mp4"
    ],
    age: "Unknown",
    birthday: "Unknown",
    origin: "Ghost City",
  ...
  },
  {
    ...
    music: [
      { title: "Meow", artist: "Meow", url: "/music/rallysong.mp3" },
      { title: "prrrt", artist: "meoww", url: "music/Bildschirmaufnahme 2026-04-20 183159.mp3" }
    ],
    defaultTrack: 0,
